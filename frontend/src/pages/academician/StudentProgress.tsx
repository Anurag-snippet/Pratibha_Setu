...
export function AcademicianStudentProgress() {
  ...
  return (
    <DashboardShell role="academician">
      <PageHeader
        ...
        title="Student Competency & Placement Directory"
        subtitle="Monitor academic cohort progress, skill benchmarks and recruitment pipeline outcomes."
      />
      ...
      <Card className="p-4 sm:p-5">
        <div className="flex flex-col gap-4">
          <div className="flex flex-1 items-center gap-2 rounded-xl bg-muted px-3.5 py-2.5">
            ...
            <input
              type="text"
              placeholder="Search students by name, top skill or placed company..."
              value={search}
              ...
              <tr>
                ...
                >
                  <span className="inline-flex items-center gap-1">
                    Skill Score <ArrowUpDown className="size-3" />
                  </span>
                </th>
                ...
                <th className="px-4 py-4">Company / Attach</th>
